...
def create_acc_msg(packer, CAN: CanBus, long_active: bool, gas: float, accel: float, stopping: bool, stopped: bool):
  """
  ...
  newDecelValue = gas == -5 and long_active and stopping and not stopped
  values = {
