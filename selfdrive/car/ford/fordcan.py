...
def create_acc_msg(packer, CAN: CanBus, long_active: bool, gas: float, accel: float, stopping: bool, desired_speed: float, brake_torque: float):
  """
  ...
  brake = accel <= -1 and gas == -5 and long_active 
  values = {
    "AccBrkTot_A_Rq": brake_torque,                          # Brake total accel request: [-20|11.9449] m/s^2
    ...
    "AccBrkDecel_B_Rq": 1 if brake else 0,             # Deceleration request: 0=Inactive, 1=Active
    "AccStopStat_B_Rq": 0,
  }
